...
string.
-}
-- subString 1 7 "Hello, world!"
subString :: Int -> Int -> String -> String
subString start end str 
    | end < 0 = ""
    | start <= 0 = take (end + 1) str
    | otherwise = subString 0 (end - start) (drop start str)
...
lowerAndGreater n = go 0 0
    where
        ...
        go lower greater l
            | null l = show n <> " is greater than " <> show lower <> " elements and lower than " <> show greater <> " elements"
